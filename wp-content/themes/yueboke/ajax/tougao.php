...
$max = dopt('d_tougao_contentmax')?dopt('d_tougao_contentmax'):5000;
$min = dopt('d_tougao_contentmin')?dopt('d_tougao_contentmin'):200;
if ( empty($content) || mb_strlen($content) > $max || mb_strlen($content) < $min ) {
    die('content');
}
