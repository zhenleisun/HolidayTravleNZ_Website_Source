        ...
        <div class="row">
            <div class="col-md-12">
                <div id="breadcrumbs_and_title">
                 <h1><?php echo __('Posts tagged with: ', 'carzine');?><a title="<?php the_title_attribute();?>" href="<?php the_permalink();?>"><?php single_cat_title();?></a></h1>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <?php while(have_posts()):the_post();?>
                    ...
                    <p><?php  echo __('No posts tagged..','carzine');?></p>
                    <?php endif;?>
                    <div class="clear"></div>
                    <div class="row">
                    <div class="col-md-12">
